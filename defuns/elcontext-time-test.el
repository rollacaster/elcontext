...
(ert-deftest elc-time-timespan-to-string ()
    ...
    (should (equal (elc-time-to-string (ht (:time (ht (:from "13:00") (:to "13:10"))))) "13:00-13:10"))
    (should (equal (elc-time-to-string (ht (:time (ht (:from "13:00") (:to "13:10") (:days '("Mon" "Tue")))))) "13:00-13:10 Mon,Tue"))
    (should (equal (elc-time-to-string (ht (:time (ht (:from "13:00") (:to "13:10") (:days '("Mon")))))) "13:00-13:10 Mon"))
